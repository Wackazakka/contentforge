...
const STYLE_PROMPTS = {
  ...
  surreal: 'Sophisticated conceptual surrealism, dreamlike scene with unexpected juxtapositions, photorealistic rendering of impossible scenarios, thought-provoking and visually arresting, Magritte and Dalí meet contemporary advertising. Subject: [TOPIC]. No text, letters, or typography.',
