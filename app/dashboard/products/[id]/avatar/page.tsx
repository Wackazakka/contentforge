          ...
          <div className={`border rounded-xl p-8 text-center ${done ? 'bg-[var(--paper-raised)] border-gray-200' : 'bg-green-50 border-green-200'}`}>
            {done ? (
              <>
                ...
                <div className="flex items-center justify-center gap-4 flex-wrap">
                  <button
                    ...
                    className="px-4 py-2 rounded-lg bg-[var(--ember-deep)] text-[var(--on-ember)] text-sm font-medium hover:bg-[var(--ink)]"
                  >
              ...
              <>
                ...
                <button onClick={() => setJobId(null)} className="mt-2 px-4 py-2 rounded-lg bg-[var(--ember-deep)] text-[var(--on-ember)] text-sm font-medium">✏️ Tilbake til redigering (alt er beholdt)</button>
              </>
            ) : (
              <>
              ...
              <div className="flex gap-2">
                ...
                {avatarImageUrl && (
                  <button
                    ...
                    className={`px-3 py-2 text-xs rounded-lg transition-colors ${savedFeedback ? 'bg-green-500 text-[var(--on-ember)]' : 'bg-[var(--ember-deep)] text-[var(--on-ember)] hover:bg-[#1450a0]'}`}
                  >
                    ...
                    <div key={i} className="border border-gray-100 rounded-lg p-3 bg-gray-50 space-y-2">
                      ...
                      <div className="flex items-center gap-2 pl-7">
                        <button
                          ...
                          className="flex items-center gap-1.5 px-3 py-1.5 text-xs rounded-lg bg-[var(--ember-deep)] text-[var(--on-ember)] hover:bg-[var(--ink)] disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0"
                        >
