        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
          ...
          <tr>
            <td style="background-color:#ffffff;border-radius:16px;border:1px solid #e5e7eb;padding:40px 40px 36px;">
              ...
              <h1 style="margin:0 0 8px;font-size:26px;font-weight:700;color:#0C447C;line-height:1.2;">
                Welcome, ${firstName}!
              </h1>
                    ...
                    <table cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="vertical-align:top;padding-right:14px;padding-top:1px;">
                          <div style="width:24px;height:24px;border-radius:50%;background-color:#185FA5;text-align:center;line-height:24px;font-size:12px;font-weight:700;color:#ffffff;">${step}</div>
                        </td>
                        <td>
          ...
          <tr>
            <td align="center" style="padding-top:24px;">
              <p style="margin:0;font-size:12px;color:#9ca3af;">
                CenterForge by Wackazakka · <a href="${BASE_URL}/privacy" style="color:#9ca3af;">Privacy policy</a>
              </p>
            </td>
          </tr>
