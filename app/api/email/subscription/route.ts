        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
          ...
          <tr>
            <td style="background-color:#FFFDF8;border-radius:16px;border:1px solid #E6DDCC;padding:40px 40px 36px;">
              <p style="margin:0 0 4px;font-size:13px;font-weight:600;color:#C5451B;text-transform:uppercase;letter-spacing:0.08em;">Payment confirmed</p>
              ...
              <!-- Summary box -->
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:32px;background-color:#F8E7DB;border-radius:12px;">
                <tr>
                  <td style="padding:20px 24px;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding-bottom:10px;">
                          <span style="font-size:13px;color:#5E564A;">Plan</span><br/>
                          <span style="font-size:15px;font-weight:600;color:#1C1A16;">${plan}</span>
                        </td>
                        <td style="padding-bottom:10px;text-align:right;">
                          <span style="font-size:13px;color:#5E564A;">Credits added</span><br/>
                          <span style="font-size:15px;font-weight:600;color:#1C1A16;">${credits}</span>
                        </td>
                      </tr>
                      ${renewsAt ? `<tr><td colspan="2" style="border-top:1px solid #d1e8ff;padding-top:10px;">
                        <span style="font-size:13px;color:#5E564A;">Renews</span><br/>
                        <span style="font-size:14px;font-weight:500;color:#C5451B;">${renewsAt}</span>
                      </td></tr>` : ''}
                    </table>
                  </td>
                </tr>
